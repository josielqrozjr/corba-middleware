...
#ifndef _TAO_IDL_CETCDS_IYBZYI_CPP_
#define _TAO_IDL_CETCDS_IYBZYI_CPP_
...
class TAO_Search_Perfect_Hash_OpTable
...
/* Command-line: ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_Search_Perfect_Hash_OpTable -N lookup */

unsigned int
TAO_Search_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
...
TAO_Search_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 10,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      {"",0,0},{"",0,0},{"",0,0},
      {"put", std::addressof(POA_Search::put_skel), nullptr},
      {"",0,0},
      {"_is_a", std::addressof(TAO_ServantBase::_is_a_thru_poa_skel), nullptr},
      {"",0,0},
      {"_get_id", std::addressof(POA_Search::_get_id_skel), 0},
      {"shutdown", std::addressof(POA_Search::shutdown_skel), nullptr},
      {"",0,0},
      {"_component", std::addressof(TAO_ServantBase::_component_thru_poa_skel), nullptr},
      {"",0,0},
      {"get", std::addressof(POA_Search::get_skel), nullptr},
      ...
      {"",0,0},{"",0,0},
      {"del", std::addressof(POA_Search::del_skel), nullptr},
    };
...
static TAO_Search_Perfect_Hash_OpTable tao_Search_optable;
...
POA_Search::POA_Search ()
  : TAO_ServantBase ()
{
  this->optable_ = std::addressof(tao_Search_optable);
}

POA_Search::POA_Search (const POA_Search& rhs)
...
class _get_id_Search
  : public TAO::Upcall_Command
{
public:
  inline _get_id_Search (
    POA_Search * servant,
...
{TAO::SArg_Traits< std::string>::ret_val retval;
  ...
  POA_Search * const impl =
    dynamic_cast<POA_Search *> (servant);
...
void POA_Search::put_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{TAO::SArg_Traits< ::ACE_InputCDR::to_boolean>::ret_val retval;
  TAO::SArg_Traits< std::string>::in_arg_val _tao_key;
  TAO::SArg_Traits< std::string>::in_arg_val _tao_value;
...
class shutdown_Search
  : public TAO::Upcall_Command
{
public:
  inline shutdown_Search (
    POA_Search * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_Search::shutdown_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< std::string>::in_arg_val _tao_password;
...
::CORBA::Boolean POA_Search::_is_a (const char* value)
{
  return
    (
...
const char* POA_Search::_interface_repository_id () const
{
...
POA_Search::_this ()
{
  ...
  if (obj.ptr ())
    {
      (void) stub.release ();
      return TAO::Narrow_Utils<::Search>::unchecked_narrow (obj.in ());
    }
  return {};
}
